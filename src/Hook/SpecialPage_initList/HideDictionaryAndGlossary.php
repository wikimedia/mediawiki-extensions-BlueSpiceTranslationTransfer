...
/**
 * Hides "Special:TranslationDictionary" and "Special:TranslationsGlossary" pages for instances which language is not leading one.
 *
...
class HideDictionaryAndGlossary implements SpecialPage_initListHook {
	...
	public function onSpecialPage_initList( &$list ) {
		if ( $this->shouldHide() ) {
			...
			unset( $list['TranslationsGlossary'] );
		}
